...
Mission Control Simple is produced from an **upstream private monorepo** via an allowlisted OSS export. These patterns keep commercial-only code out of this repository.
