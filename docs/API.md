...
The Control Hub Memory page (Hindsight tab) does not call `list` on load; it only requests memories when the user clicks **Recall** (`action=recall` with `query`).
...

{
  ...
  "data": {
    ...
    "path": "~/.hermes/skills/control-hub/SKILL.md",
