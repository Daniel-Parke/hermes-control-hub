...
- Default **Control Hub data directory** is now **`$HOME/control-hub/data`** (was `$HERMES_HOME/control-hub/data`). Set **`CH_DATA_DIR`** if you keep files in the old location. See [docs/MIGRATION.md](docs/MIGRATION.md).
