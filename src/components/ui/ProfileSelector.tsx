...
const PROFILES = [
  ...
  { id: "ch-qa-engineer", name: "QA Engineer", description: "Quality assurance, bug fixing, testing" },
  { id: "ch-devops-engineer", name: "DevOps Engineer", description: "Infrastructure, deployment, CI/CD" },
  { id: "ch-swe-engineer", name: "SWE Engineer", description: "Feature development, code improvement" },
  { id: "ch-data-engineer", name: "Data Engineer", description: "Data pipelines, ETL, schemas" },
  { id: "ch-data-scientist", name: "Data Scientist", description: "ML models, analytics, experiments" },
  { id: "ch-ops-director", name: "Operations Director", description: "Strategy, finance, market research" },
  { id: "ch-creative-lead", name: "Creative Lead", description: "Content, design, marketing" },
  { id: "ch-support-agent", name: "Support Agent", description: "Research, legal, security" },
];
