...
const BASE =
  "w-full rounded-lg border border-ps-edge bg-ps-surface-panel px-3 py-2 text-body text-ps-text-primary placeholder-ps-text-muted outline-none transition-colors hover:border-ps-edge-emphasis focus:border-neon-cyan/50 focus:ring-1 focus:ring-neon-cyan/30 disabled:cursor-not-allowed disabled:opacity-40";
