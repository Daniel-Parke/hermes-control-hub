...
export default function ContinueStoryModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-ps-surface-ground/80 backdrop-blur-sm flex items-center justify-center p-4" onClick={onCancel} role="presentation">
      ...
      >
        <h3 id="continue-story-title" className="text-sm font-semibold text-white">Continue story</h3>
        ...
        <textarea
          ...
          className="w-full bg-ps-surface-inset border border-ps-edge rounded-lg px-4 py-3 text-sm text-white placeholder-white/20 outline-none focus:border-green-500/30 font-mono resize-none"
        />
        <div>
